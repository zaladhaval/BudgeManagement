(function ($) {
    ...
    function setTheme(){
      var that = $('.setting');
      // bg
      $('body').removeClass($('body').attr('ui-class')).addClass("dark").attr('ui-class', 'dark');
      // folded
      ...
      that.find('input[name="folded"]').prop('checked', false);
      that.find('input[name="fixedContent"]').prop('checked', false);
      that.find('input[name="fixedAside"]').prop('checked', false);
      that.find('input[name="container"]').prop('checked', false);
      that.find('input[name="ajax"]').prop('checked', true);

      that.find('input[name="theme"][value=primary]').prop('checked', true);
