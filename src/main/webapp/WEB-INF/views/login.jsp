...
<body class="login">
	...
	<script>
		jQuery(document).ready(function () {
			...
			$.backstretch([
				"resources/assets/admin/pages/media/bg/bg1.jpg",
				"resources/assets/admin/pages/media/bg/bg2.jpg",
				"resources/assets/admin/pages/media/bg/bg3.jpg",
				"resources/assets/admin/pages/media/bg/bg4.jpg"
			], {
					fade: 1000,
					duration: 8000
				}
