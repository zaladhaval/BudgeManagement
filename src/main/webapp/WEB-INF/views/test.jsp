...
<head>
	...
	<link rel="stylesheet" type="text/css"
		href="resources/assets/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css" />
	<link rel="stylesheet" type="text/css"
		href="resources/assets/global/plugins/bootstrap-markdown/css/bootstrap-markdown.min.css">
	<link rel="stylesheet" type="text/css"
		href="resources/assets/global/plugins/bootstrap-datepicker/css/datepicker.css" />
	<!-- END PAGE LEVEL SCRIPTS -->
	<!-- BEGIN THEME STYLES -->
	<link href="resources/assets/global/css/components-rounded.css" id="style_components" rel="stylesheet"
		type="text/css" />
	<link href="resources/assets/global/css/plugins.css" rel="stylesheet" type="text/css" />
	<link href="resources/assets/admin/layout4/css/layout.css" rel="stylesheet" type="text/css" />
	<link id="style_color" href="resources/assets/admin/layout4/css/themes/light.css" rel="stylesheet"
		type="text/css" />
	<link href="resources/assets/admin/layout4/css/custom.css" rel="stylesheet" type="text/css" />
	<!-- END THEME STYLES -->
...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
	...
	<div class="page-header navbar navbar-fixed-top">
		...
		<div class="page-header-inner">
			...
			<div class="page-logo">
				<a href="index.html">
					<img src="resources/assets/admin/layout4/img/logo-light.png" alt="logo" class="logo-default" />
				</a>
					...
					<ul class="nav navbar-nav pull-right">
									...
									<ul class="dropdown-menu-list scroller" style="height: 275px;"
										...
										<li>
											<a href="inbox.html?a=view">
												<span class="photo">
													<img src="resources/assets/admin/layout3/img/avatar2.jpg"
										...
										<li>
											<a href="inbox.html?a=view">
												<span class="photo">
													<img src="resources/assets/admin/layout3/img/avatar3.jpg"
														class="img-circle" alt="">
												</span>
												<span class="subject">
													<span class="from">
										...
										<li>
											<a href="inbox.html?a=view">
												<span class="photo">
													<img src="resources/assets/admin/layout3/img/avatar1.jpg"
														class="img-circle" alt="">
												</span>
												<span class="subject">
													<span class="from">
											...
											<a href="javascript:;">
												...
												<span class="progress progress-striped">
													<span style="width: 38%;"
														...
														aria-valuemin="0" aria-valuemax="100"><span class="sr-only">38%
															Complete</span></span>
												</span>
											</a>
										</li>
						...
						<li class="dropdown dropdown-user dropdown-dark">
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
								...
								<img alt="" class="img-circle" src="resources/assets/admin/layout4/img/avatar9.jpg" />
							</a>
								...
								<form action="#" class="form-horizontal">
									<div class="form-body">
										...
										<div class="form-group has-warning">
											<label class="control-label col-md-3" for="inputWarning">Input with
												warning</label>
											<div class="col-md-4">
										...
										<div class="form-group has-error">
											<label class="control-label col-md-3" for="inputError">Input with
												error</label>
											<div class="col-md-4">
										...
										<div class="form-group has-success">
											<label class="control-label col-md-3" for="inputSuccess">Input with
												success</label>
											<div class="col-md-4">
						...
						<div class="portlet box green">
							...
							<div class="portlet-body form">
								...
								<form action="#" id="form_sample_3" class="form-horizontal">
									<div class="form-body">
										<h3 class="form-section">Advance validation. <small>Custom radio buttons,
												checkboxes and Select2 dropdowns</small></h3>
										<div class="alert alert-danger display-hide">
											<button class="close" data-close="alert"></button>
											You have some form errors. Please check below.
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="hidden" class="form-control" id="select2_tags" value=""
													name="select2tags">
												<span class="help-block">
													select tags </span>
											</div>
										...
										<div class="form-group">
											<label class="control-label col-md-3">WYSIHTML5 Editor <span
													class="required">
													* </span>
											</label>
											<div class="col-md-9">
...
<![endif]-->
	...
	<script type="text/javascript"
		src="resources/assets/global/plugins/jquery-validation/js/additional-methods.min.js"></script>
	<script type="text/javascript" src="resources/assets/global/plugins/select2/select2.min.js"></script>
	<script type="text/javascript"
		src="resources/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
	<script type="text/javascript"
		src="resources/assets/global/plugins/bootstrap-wysihtml5/wysihtml5-0.3.0.js"></script>
	<script type="text/javascript"
		src="resources/assets/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script>
	<script type="text/javascript" src="resources/assets/global/plugins/ckeditor/ckeditor.js"></script>
	<script type="text/javascript"
		src="resources/assets/global/plugins/bootstrap-markdown/js/bootstrap-markdown.js"></script>
